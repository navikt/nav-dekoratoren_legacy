...
import { refreshProxyConfig, sessionProxyConfig } from './api-handlers/session';
...
app.get(createPaths('/api/session'), sessionProxyConfig);
app.get(createPaths('/api/session/refresh'), refreshProxyConfig);
