...
export const ledetekster = {
    ...
    'snart-logget-ut-tittel': 'Du blir snart logget ut automatisk',
    'snart-logget-ut-tittel-en': 'You will soon be logged out automatically',
    'snart-logget-ut-tittel-se': 'Du blir snart logget ut automatisk',
    'snart-logget-ut-body': 'Vil du fortsatt være innlogget?',
    'snart-logget-ut-body-en': 'Would you like to stay logged in?',
    'snart-logget-ut-body-se': 'Vil du fortsatt være innlogget?',
