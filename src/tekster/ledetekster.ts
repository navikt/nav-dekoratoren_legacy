export const ledetekster: { [key: string]: string } = {
    ...
    'ga-til-min-side': 'Til forsiden',
    'ga-til-min-side-en': 'Til forsiden',
    'ga-til-min-side-se': 'Til forsiden',
    ...
    'ga-til-min-side-arbeidsgiver': 'Til Min side',
    'ga-til-min-side-arbeidsgiver-en': 'Til Min side',
    'ga-til-min-side-arbeidsgiver-se': 'Til Min side',
