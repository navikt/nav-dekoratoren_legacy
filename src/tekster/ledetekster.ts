export const ledetekster: { [key: string]: string } = {
    ...
    'rapporter-om-feil-mangler': 'Meld ifra om feil og mangler',
    'rapporter-om-feil-mangler-en': 'Report errors and omissions',
    'rapporter-om-feil-mangler-se': 'Meld ifra om feil og mangler',
    ...
    'lite-forstaelig': 'Jeg forsto ikke innholdet',
    'lite-forstaelig-en': 'I did not understand the information',
    'lite-forstaelig-se': 'Jeg forsto ikke innholdet',
