...
export const ledetekster: { [key: string]: stringOrFunction } = {
    ...
    'hva-lette-du-etter': 'Hva lette du etter?',
    'hva-lette-du-etter-en': 'What were you looking for?',
    'hva-lette-du-etter-se': 'Hva lette du etter?',
    ...
    'kontakt-oss-2-en': ' if you need help.',
    'kontakt-oss-1-se': 'Kontakt oss',
    'kontakt-oss-2-se': ' hvis du trenger hjelp.',
    ...
    'advarsel-om-personopplysninger-en': 'Do not write personal or sensitive information.',
    'advarsel-om-svar-en': 'You will not receive a response to your feedback.',
    ...
    'textarea-feilmelding-en': (input: string) => `You cannot write more than ${input} characters`,
    ...
    'personvern-feilmelding-2': (input: string) => `${input} må fjernes før du kan gå videre.`,
    'personvern-feilmelding-en': (input: string) => `It looks like you have written ${input}. `,
    'personvern-feilmelding-2-en': (input: string) => `${input}  have to be removed before you can submit.`,
    'personvern-feilmelding-se': (input: string) => `Det ser ut som du har skrevet inn ${input}. `,
    'personvern-feilmelding-2-se': (input: string) => `${input} må fjernes før du kan gå videre.`,
    ...
    'violation-tlf-en': 'a telephone number',
    ...
    'send-inn-tilbakemelding-en': 'Send reply',
    ...
    'annet-en': 'Other',
    'annet-se': 'Annet',
    'spørsmål-ikke-besvart': 'Innholdet besvarte ikke mitt spørsmål',
    'spørsmål-ikke-besvart-en': 'The content did not answer my question',
    'spørsmål-ikke-besvart-se': 'Innholdet besvarte ikke mitt spørsmål',
    'forstod-ikke': 'Jeg forstod ikke innholdet',
    'forstod-ikke-en': 'I did not understand the content',
    'forstod-ikke-se': 'Jeg forstod ikke innholdet',
    'hjelpemiddel-feil': 'Siden fungerer ikke med min skjermleser',
    'hjelpemiddel-feil-en': 'The page does not work with my accessibility device',
    'hjelpemiddel-feil-se': 'Siden fungerer ikke i min skjermleser',
    'svar-mangler': 'Du må velge et alternativ',
    'svar-mangler-en': 'You must select an option',
    'svar-mangler-se': 'Du må velge et alternativ',
