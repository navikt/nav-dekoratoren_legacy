...
export const ledetekster: { [key: string]: stringOrFunction } = {
    ...
    'varsler-visalle': 'Tidligere oppgaver og beskjeder',
    'varsler-visalle-en': 'Previous tasks and messages',
    'varsler-visalle-se': 'Tidligere oppgaver og beskjeder',
    ...
    'varsler-tom-liste-ingress-en': `We will alert you when something happens`,
